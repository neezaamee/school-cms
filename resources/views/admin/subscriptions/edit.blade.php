...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-auto">
                <h5 class="mb-0">Edit Package: {{ $subscriptionPackage->name }}</h5>
            </div>
            <div class="col-auto">
        ...
        <form action="{{ route('subscription-packages.update', $subscriptionPackage->id) }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" id="name" name="name" type="text" value="{{ old('name', $subscriptionPackage->name) }}" required />
                ...
                <div class="col-12">
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" id="has_tech_support" name="has_tech_support" type="checkbox" {{ old('has_tech_support', $subscriptionPackage->has_tech_support) ? 'checked' : '' }} />
