                        ...
                        <div class="card-body border-top">
                            <div class="row g-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control mask-phone" id="phone" name="phone" type="text" value="{{ old('phone') }}" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="emergency_phone">Emergency Phone</label>
                                    <input class="form-control mask-phone" id="emergency_phone" name="emergency_phone" type="text" value="{{ old('emergency_phone') }}" />
                                </div>
