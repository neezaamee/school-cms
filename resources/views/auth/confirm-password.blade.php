...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <title>Confirm Password | ElafTech School Services</title>
                  ...
                  <div class="col-md-12 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center">
                        ...
                        <h4 class="mt-3">Security Check</h4>
                        <p class="mb-0 fs-10 text-600">This is a secure area of the application. Please confirm your password before continuing.</p>
                      </div>
                      ...
                      <form class="mt-4" method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="mb-3">
                          <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Confirm</button>
                        </div>
                      </form>
                    </div>
                  </div>
