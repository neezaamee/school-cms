...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <title>Forgot Password | ElafTech School Services</title>
                  ...
                  <div class="col-md-12 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center">
                        ...
                        <p class="mb-0 fs-10">Enter your email and we'll send you a reset link.</p>
                      </div>
                      
                      <!-- Session Status -->
                      @if (session('status'))
                        <div class="alert alert-success mt-3 fs-10" role="alert">
                            {{ session('status') }}
                        </div>
                      @endif
                      ...
                      <form class="mt-4" method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="mb-3">
                          <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Email Reset Link</button>
                        </div>
                      </form>
                      <div class="text-center mt-3">
                        <a class="fs-10" href="{{ route('login') }}">Return to login</a>
                      </div>
                    </div>
                  </div>
                </div>
